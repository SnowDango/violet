...
import com.snowdango.violet.presenter.common.component.GridAlbumComponent
...
@Composable
fun AlbumScreen(
    viewModel: AlbumViewModel = koinViewModel<AlbumViewModel>(),
...
@Composable
fun LazyAlbumsView(
    albums: ItemSnapshotList<AlbumViewData>,
    onAlbumDetailNavigate: (albumId: Long) -> Unit
) {
