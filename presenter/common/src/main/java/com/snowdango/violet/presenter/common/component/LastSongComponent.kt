...
import com.snowdango.violet.presenter.common.extention.squareConformFillMaxWidth
import com.snowdango.violet.presenter.common.view.LastSongArtWorkImage
import com.snowdango.violet.presenter.common.view.MarqueeText
import com.snowdango.violet.presenter.common.view.TwitterImageButton
...
@Composable
fun LastSongComponent(lastSongs: List<LastSongViewData>) {

    val fraction = 0.6f

    val lastSong = lastSongs.filter { it.canShow }.maxByOrNull { it.datetime }
    lastSong?.let {
        ConstraintLayout(
            modifier = Modifier
                .fillMaxWidth()
